...
const FooterLinks = () => {
  return (
    <div className="w-full header-gradient justify-center pb-[3rem]">
      <div className="flex flex-col sm:flex-wrap sm:flex-row max-w-[980] justify-center text-slate-100 px-2 mx-2 pt-[1.5rem]">
        <div className="flex text-sm sm:text-base flex-col px-[2rem] border-b-[1px] pb-[1rem] mx-[1rem] sm:border-r-[1px] sm:border-b-0 border-slate-100 lg:px-[4rem]">
          <h1 className="text-white  font-semibold mt-1">Contact</h1>
        ...
        <div className="flex text-sm sm:text-base flex-col px-[2rem] border-b-[1px] sm:border-b-0 mx-[1rem] pb-[1rem] md:border-r-[1px] border-slate-100 lg:pr-[6rem] lg:pl-[5rem] mt-4 sm:mt-0">
          <h1 className="text-white font-semibold mt-1">Menu</h1>
        ...
        <div className="flex text-sm sm:text-base flex-col px-[3rem] mt-4 md:mt-3 md+:mt-0 lg:px-[4rem]">
          <h1 className="text-white  font-semibold mt-1">Recent Posts</h1>
