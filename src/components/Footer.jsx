...
const Footer = () => {
  ...
  return (
    <div className="bottom-0 flex bg-slate-600 justify-center">
      <div className="flex flex-col p-4 md:max-w-[770px] xl:max-w-[770px] justify-center">
        <h1 className="text-white text-base font-semibold my-2">
        ...
        <div className="flex mt-2">
          <input
            ...
            className="px-1 py-0.5 rounded-md grow max-w-[500px] indent-1"
          ></input>
          <button
        ...
        <div className="ml-1 text-xs text-white mt-2 p-0">
