  ...
  return (
    <div className="w-full flex mt-4 pb-6 fade-in-effect sm:mt-8 justify-center">
      <div className="flex flex-row justify-center p-2 max-w-[950px]">
        ...
        >
          <div className="flex mt-5 font-semibold text-white text-center justify-center text-xl xs:text-2xl sm:text-2xl md:text-3xl md:mt-[3rem] lg:text-4xl">
            <p className="">Lets.</p>
          ...
          <div className="mt-2">
            <button
              className="rounded-md text-sm bg-orange-600 text-white px-2 py-0.5 sm:text-base md:text-lg md:mt-1"
              onClick={() => {
                navigate("/register");
              }}
            >
